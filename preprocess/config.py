...
date_range_start = '2015-09-28'
date_range_end = '2020-01-03'
max_num_tweets = 100
stock_listing_symbols = ['AAPL', 'ACN', 'ADBE', 'ADBE', 'AMD', 'AVGO', 'CAJ', 'CSCO', 'GOOGL', 'GRMN', 'IBM', 'INTC', 'MSFT', 'MSI', 'NVDA', 'QQQ', 'TXN']
