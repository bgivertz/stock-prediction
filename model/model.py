...
def train(model, train_inputs, train_labels):
    ...
    train_inputs = tf.reshape(train_inputs[0:num_winds * model.window_size],
                              (num_winds, model.window_size, model.input_size))
    ...
    for i in range(num_batches):
        ...
        if i % 5 == 0:
            print("batch", i, "of", num_batches, " // Avg Loss: ", loss / model.batch_size, " // Perplexity: ",
                  np.exp(np.mean(all_loss)))
